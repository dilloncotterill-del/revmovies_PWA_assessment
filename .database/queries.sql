...
SELECT Users.ID, Reviews.user_id
FROM Users
FULL (OUTER) JOIN Reviews ON Users.ID=Reviews.user_id;

SELECT Movies.ID, Reviews.movie_id
FROM Movies
FULL (OUTER) JOIN Reviews ON Movies.ID=Reviews.movie_id
